    ...
    <div className='relative text-white text-[20px] w-full max-w-[1360px] mx-auto'>
        ...
        >
            <div>
                ...
                />
                <p className='px-[15px] md:px-[40px] py-[10px] md:py-[25px] font-oswald 
                bg-white absolute bottom-[25px] md:bottom-[75px] left-0 text-black/[0.9] 
                text-[15px] md:text-[30px] uppercase font-medium cursor-pointer'>Number 1</p>
            </div>
            <div>
                <img src="/02.jpg"  
                className='aspect-[16/10] md:aspect-auto object-cover'
                ...
                <p className='px-[15px] md:px-[40px] py-[10px] md:py-[25px] font-oswald 
                bg-white absolute bottom-[25px] md:bottom-[75px] left-0 text-black/[0.9] 
                text-[15px] md:text-[30px] uppercase font-medium cursor-pointer'>Number 2</p>
            </div>
            <div>
                <img src="/03.jpg"  
                className='aspect-[16/10] md:aspect-auto object-cover'
                ...
                <p className='px-[15px] md:px-[40px] py-[10px] md:py-[25px] font-oswald 
                bg-white absolute bottom-[25px] md:bottom-[75px] left-0 text-black/[0.9] 
                text-[15px] md:text-[30px] uppercase font-medium cursor-pointer'>Number 3</p>
            </div>
